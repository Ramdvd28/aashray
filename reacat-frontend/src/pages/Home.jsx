...
export default function Home() {
  ...
  // ── Redirect + load data ────────────────────────────────────
  useEffect(() => {
    const activeUserId = user?.id || "demo-worker-001";
    dashboardApi.get(activeUserId)
      .then(data => {
        setDashData(data);
  ...
  return (
    <div style={{ display:"flex" }}>
      ...
      <div className="mobile-header">
        <div className="logo">
          <span className="logo-safe">Aash</span>
          <span className="logo-ride">ray</span>
        </div>
          ...
          <div style={{ padding:"1.5rem 2.5rem 3rem" }}>
            ...
            <div className="compare-box">
              ...
              <div className="compare-cols">
                ...
                <div>
                  <div className="compare-col-title text-accent">✅ Aashray Parametric</div>
